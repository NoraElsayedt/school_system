...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{trans('Student.students')}}/</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">update</span>
						</div>
					</div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input  type="text" name="name_ar" value="{{$Student_id->getTranslation('name' ,'ar')}}" class="form-control">
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input  class="form-control"  value="{{$Student_id->getTranslation('name' ,'en')}}" name="name_en" type="text" >
                                    </div>
                                </div> 
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email"  name="email"  value="{{$Student_id->email}}" class="form-control" >
                                    </div>
                                    @error('email')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input  type="password" name="password"  value="{{$Student_id->password}}"  class="form-control" >
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select mr-sm-2" name="gender_id">
                                            <option selected value="{{$Student_id->gender_id}}" >{{$Student_id->gender->Name}}</option>
                                            <option  >{{trans('MyParent.Choose')}}...</option>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select mr-sm-2" name="nationalitie_id">
                                            <option selected value="{{$Student_id->nationalitie_id}}" >{{$Student_id->nationalitie->name_nationalitie}}</option>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select mr-sm-2" name="blood_id">
                                            <option selected value="{{$Student_id->blood_id}}" >{{$Student_id->blood->name_blood}}</option>
                                            <option  disabled>{{trans('MyParent.Choose')}}...</option>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="date" value="{{$Student_id->Date_of_Birth}}"  id="datepicker-action" name="Date_Birth" data-date-format="yyyy-mm-dd">
                                    </div>
                                    @error('Date_Birth')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select mr-sm-2" name="Grade_id">
                                            <option selected value="{{$Student_id->grade_id}}" >{{$Student_id->Grade->name}}</option>
                                            <option  disabled>{{trans('MyParent.Choose')}}...</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="Classroom_id" id="classroomDropdown">
                                        <option selected value="{{$Student_id->classroom_id}}" >{{$Student_id->classrooms->name_class}}</option>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select mr-sm-2" name="section_id">
                                            <option selected value="{{$Student_id->section_id}}" >{{$Student_id->section->name_section}}</option>
       <!-- Options will be populated via Ajax -->
                                        </select>
                                    </div>
                                    @error('section_id')
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select mr-sm-2" name="parent_id">
                                            <option selected value="{{$Student_id->myparent_id}}" >{{$Student_id->myparent->name_f}}</option>
                                            <option  disabled>{{trans('MyParent.Choose')}}...</option>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="custom-select mr-sm-2" name="academic_year">
                                        <option selected value="{{$Student_id->academic_year}}" >{{$Student_id->academic_year}}</option>
                                        <option  disabled>{{trans('MyParent.Choose')}}...</option>
                                        @php
                                            $current_year = date("Y");
                                        @endphp
