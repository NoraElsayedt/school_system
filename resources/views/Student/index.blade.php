                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown show">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                    <a class="dropdown-item" href="{{route('Student.show',$Student->id)}}"><i style="color: #ffc107" class="far fa-eye "></i>&nbsp;  تعديل بيانات الطالب</a>
                                                  
                                                  <a class="dropdown-item" href="{{route('Student.edit',$Student->id)}}"><i style="color:green" class="fa fa-edit"></i>&nbsp;   بيانات الطالب</a>
