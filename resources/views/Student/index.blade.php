                    ...
                    <table class="table text-md-nowrap" id="example1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $Student->classrooms->name_class }} <span>{{$Student->Joining_Date}}</span></td>
                                <td>{{$Student->section->name_section}}</td>
                                <td>
                                    <a href="{{route('Student.show',$Student->id)}}" class="btn btn-info btn-sm" role="button" aria-pressed="true"><i class="fa fa-edit"></i></a>
