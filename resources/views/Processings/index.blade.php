...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">استبعاد رسوم
                            </h4>
                                ...
                                <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                    ...
                                    @foreach($ProcessingFees as $ProcessingFee)
                                        ...
                                        <td>{{$ProcessingFee->description}}</td>
                                            <td>
                                                <a href="{{route('Processing.edit',$ProcessingFee->id)}}" class="btn btn-info btn-sm" role="button" aria-pressed="true"><i class="fa fa-edit"></i></a>
