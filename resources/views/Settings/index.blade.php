...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">Setting</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Setting</span>
						</div>
					</div>
        ...
        <div class="card card-statistics h-100">
            <div class="card-body">
                <form enctype="multipart/form-data" method="post" action="{{route('Settings.update','test')}}">
                    ...
                    <div class="row">
                        <div class="col-md-6 border-right-2 border-right-blue-400">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    <div class="mb-3">
                                        <img style="width: 100px; height: 100px;" src="{{ URL::asset('app/Library/'.$setting['school_name'].'/'.$setting['logo']) }}" alt="">
                    ...
                    <hr>
                    <button class="btn btn-success  nextBtn btn-lg pull-right" type="submit">{{trans('Student.submit')}}</button>
                </form>
            </div>
        </div>
    </div>
