    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class=" row mb-30" action="{{ route('Classroom.update', $classrooms->id) }}" method="POST">
                    {{method_field('patch')}}
                    @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <label for="Name"
                                                ...
                                                :</label>
                                            <input class="form-control" type="text" name="Name"  value="{{$classrooms->getTranslation('name_class', 'ar')}}" />
                                        </div>
                                        ...
                                        <div class="col">
                                            <label for="Name"
                                                ...
                                                :</label>
                                            <input class="form-control" type="text" name="Name_class_en"  value="{{$classrooms->getTranslation('name_class', 'en')}}"  />
                                        </div>
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="col">
                                                <select class="form-control" name="Grade_id">
                                                    <option value="{{ $classrooms->grades->id}}">
                                                        {{ $classrooms->grades->name }}
                                                    </option>
