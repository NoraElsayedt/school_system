        ...
        <div class="dropdown user-pro-body">
            <div class="">
                <img alt="user-img" class="avatar avatar-xl brround"
                    src="{{ URL::asset('dashboard/assets/img/faces/6.jpg') }}"><span
    ...
    <ul class="side-menu">
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                ...
                </svg><span class="side-menu__label">{{ trans('main-sidebar_trans.grade') }}</span><i
                    class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
                <li><a class="slide-item"
                        href="{{ route('Grade.index') }}">{{ trans('main-sidebar_trans.list') }}</a></li>
            </ul>
        </li>
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                ...
                </svg><span class="side-menu__label">{{ trans('Classroom.title_page') }}</span><i
                    class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
                <li><a class="slide-item"
                        href="{{ route('Classroom.index') }}">{{ trans('Classroom.List_classes') }}</a></li>
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                ...
                </svg><span class="side-menu__label">{{ trans('Sections.title_page') }}</span><i
                    class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
                <li><a class="slide-item"
                        href="{{ route('Sections.index') }}">{{ trans('Sections.List_Grade') }}</a></li>
        ...
        <li class="slide">
            ...
            <ul class="slide-menu">
                <li><a class="slide-item"
                        href="{{ route('show_form_wizard.index') }}">{{ trans('MyParent.List_Parents') }}</a></li>
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href=""><svg xmlns="http://www.w3.org/2000/svg"
                ...
                </svg><span class="side-menu__label">{{ trans('main-sidebar_trans.Teachers') }}</span><i
                    class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">


                <li><a class="slide-item"
                        href="{{ route('Teacher.index') }}">{{ trans('main-sidebar_trans.List_Teachers') }}</a>
                </li>
            </ul>
        </li>
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href=""><svg
                    ...
                    <circle cx="14.5" cy="7.5" r="1.5" />
                    <circle cx="17.5" cy="11.5" r="1.5" />
                </svg><span class="side-menu__label">حصص اون لاين</span><i
                    class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                ...
                </svg><span class="side-menu__label">{{ trans('Student.students') }}</span><i
                    class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
                <li><a class="slide-item"
                        href="{{ route('Student.create') }}">{{ trans('Student.add_student') }}</a></li>
                <li><a class="slide-item"
                        href="{{ route('Student.index') }}">{{ trans('Student.list_students') }}</a></li>
                <li><a class="slide-item"
                        href="{{ route('Promotion.index') }}">{{ trans('Student.Students_Promotions') }}</a></li>
                <li><a class="slide-item" href="{{ route('Promotion.create') }}"> ادارة ترقية الطلاب
                        ادارة ترقية الطلاب
                    </a></li>
                <li> <a class="slide-item"
                        href="{{ route('Graduated.create') }}">{{ trans('Student.add_Graduate') }}</a> </li>
                <li> <a class="slide-item"
                        href="{{ route('Graduated.index') }}">{{ trans('Student.list_Graduate') }}</a> </li>
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                ...
                </svg><span class="side-menu__label">الرسوم</span><i class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                ...
                </svg><span class="side-menu__label">حضور و غياب </span><i
                    class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    <path
                        d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zM7 9c0-2.76 2.24-5 5-5s5 2.24 5 5c0 2.88-2.88 7.19-5 9.88C9.92 16.21 7 11.85 7 9z" />
                    <circle cx="12" cy="9" r="2.5" />
                </svg><span class="side-menu__label"> Library</span><i class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                ...
                </svg><span class="side-menu__label">المواد الدراسيه</span><i
                    class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}">
                ...
                </svg><span class="side-menu__label">الامتحانات</span><i class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                ...
                </svg><span class="side-menu__label">الامتحانات الشهريه </span><i
                    class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
        ...
        <li class="slide">
            <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    <path
                        d="M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zM9 6c0-1.66 1.34-3 3-3s3 1.34 3 3v2H9V6zm9 14H6V10h12v10zm-6-3c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2z" />
                </svg><span class="side-menu__label"> الاسئلة </span><i class="angle fe fe-chevron-down"></i></a>
            <ul class="slide-menu">
